...
<script language="javascript">
		...
		function buyProduct(fid,sid) {
	
			location.href="CartServlet?fromPage=/Cart.jsp&fid=" + fid +"&sid="+ sid+ "&act=buyFood";
		}
		...
		<div class="rightArea">
			<div class="des_content">
				...
				<div class="shop_buy" style="float: left;">
					...
					<button class="shopping_btn" onclick="buyProduct('${ShowFoodBean.fid}','${ShowFoodBean.sid}');"></button>
			</div>
