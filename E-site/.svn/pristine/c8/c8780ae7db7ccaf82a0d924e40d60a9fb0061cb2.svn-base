...
function init(d_start,d_end)
{
     ...
     temp_str="<table border=\"1\" bgcolor=\"#f5fcfe\" bordercolor=\"#a5d2eb\"><tr align='center'><td colspan=7 onmouseover=\"overcolor(this)\">";
     temp_str+="<input type=\"Button\" value=\"<<\" onclick=\"change_date(-1,1)\" onmouseover=\"getlayerfocus()\" style=\"color: #0b54ab; background-color: #e8f9fe; cursor: hand; border:1px solid #a5d2eb\">-";
     ...
     temp_str+="<font color=#0b54ab>一</font></td><td>"; 
     temp_str+="<font color=#0b54ab>二</font></td><td>"; 
     temp_str+="<font color=#0b54ab>三</font></td><td>"
     temp_str+="<font color=#0b54ab>四</font></td><td>";
     temp_str+="<font color=#0b54ab>五</font></td><td>"; 
     temp_str+="<font color=#0b54ab>六</font></td></tr>";
     for (i=1 ;i<=6 ;i++)
     {
        temp_str+="<tr align='center'>";
        for(j=1;j<=7;j++){
            temp_str+="<td name=\"c"+i+"_"+j+"\" id=\"c"+i+"_"+j+"\" style=\"CURSOR: hand\" style=\"COLOR:#0b54ab\" language=\"javascript\" onmouseover=\"overcolor(this)\" onmouseout=\"outcolor(this)\" onclick=\"td_click(this)\">?</td>"
        }
        temp_str+="</tr>"        
     }
     temp_str+="</td></tr>";

     temp_str+="<tr style=\"font-size:9pt\"><td colspan=7 align='center' valign='middle'><font color=#0b54ab>今天:</font>";
     temp_str+="<font color=#0b54ab><span style=\"CURSOR: hand\" onmouseover=\"overcolor(this)\" onmouseout=\"outcolor(this)\" kind=\"today\" onclick=\"td_click(this)\">"+getNow()+"</span></font>";
     temp_str+=" &nbsp;&nbsp;<font color=#0b54ab><span style=\"CURSOR: hand\" onmouseover=\"overcolor(this)\" onmouseout=\"outcolor(this)\" kind=\"clear\" onclick=\"td_click(this)\">清空</span></font></td></tr>";
...
{
  if (obj.style.cursor=="hand") obj.style.color = "red";
  inover=true;
  window.cele_date.focus();
}
function outcolor(obj)
{
	obj.style.color = "#0b54ab";
	inover=false;
}
function getNow(){
    var Stamp=new Date();
