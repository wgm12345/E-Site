...
<body>
<h1>
<span class="action-span"><a href="<c:url value="/Admin/Product_Info.jsp?suser=${userBean.sid}" />">资料显示</a></span>
<span class="action-span"><a href="<c:url value="/Admin/Product_Einfo1.jsp?suser=${userBean.sid}" />">资料修改</a>&nbsp;&nbsp;</span>
<span class="action-span"><a href="<c:url value="/Admin/Product_List1.jsp" />">商品列表</a>&nbsp;&nbsp;</span>
<a href='<c:url value="/Admin/Admin_Main.jsp" />'>管理中心</a> - 商品资料 
</h1>
<div class="main-div1">
