...
%><%
  ...
  //设置字体
    g.setFont(new Font(fontTypes[random.nextInt(fontTypesLength)], Font.BOLD, 12 + random.nextInt(6)));
  //将此汉字画到图片上
    g.drawString(rand, 20 * i + 10 + random.nextInt(8), 16);
  }
  //将认证码存入session
