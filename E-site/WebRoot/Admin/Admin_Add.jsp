...
<span><a href="<c:url value='/Admin/Admin_Main.jsp ' />">管理中心</a>  - 添加管理员 </span>
</h1>
<div class="main-div">
...
<table width="100%" >
  ...
  <tr>
    ...
    <td><input type="radio" name="ssex" value="man" checked="checked" />&nbsp;男&nbsp;<input type="radio" name="ssex" value="woman" />&nbsp;女&nbsp;</td>
  </tr>
  <tr>
