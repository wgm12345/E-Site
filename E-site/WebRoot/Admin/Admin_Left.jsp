...
<!-- 
  ...
  <li class="explode" name="menu" id="img_3">
   ...
   -->
    ...
    <li class="explode" name="menu" id="img_1">
    <span onclick="toggleCollapse(1);">商品管理</span>
		<ul id="collapse_1">
		<li class="menu-item"><a href="Product_Add.jsp" target="main-frame">添加商品</a></li>
        <li class="menu-item"><a href="Product_List1.jsp" target="main-frame">商品列表</a></li>
        </ul>
  </li>
  <li class="explode" name="menu" id="img_2">
