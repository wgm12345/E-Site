...
<body>
<h1>
<span class="action-span"><a href="<c:url value="/Admin/Customer_Info.jsp?suser=${param.suser}" />">资料显示</a></span>
<span class="action-span"><a href="<c:url value="/Admin/Customer_Einfo.jsp?suser=${param.suser}" />">资料修改</a>&nbsp;&nbsp;</span>
<span class="action-span"><a href="<c:url value="/Admin/Customer_List.jsp" />">会员列表</a>&nbsp;&nbsp;</span>
<span><a href="<c:url value="/Admin/Admin_Main.jsp" />">管理中心</a>  - 会员资料修改 </span>
